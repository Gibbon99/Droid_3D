...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)hdr/system $(IncludeSwitch)hdr/bsp $(IncludeSwitch)hdr/console $(IncludeSwitch)hdr/game $(IncludeSwitch)hdr/glload $(IncludeSwitch)hdr/glm $(IncludeSwitch)hdr/io $(IncludeSwitch)hdr/libGL $(IncludeSwitch)hdr/openGL $(IncludeSwitch)hdr/script $(IncludeSwitch)hdr/physfs $(IncludeSwitch)/usr/local/include/bullet $(IncludeSwitch)/usr/local/include/bullet/LinearMath $(IncludeSwitch)/usr/include/freetype2 $(IncludeSwitch)hdr/libGL/freetype-gl 
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)glfw $(LibrarySwitch)GL $(LibrarySwitch)GLU $(LibrarySwitch)glload $(LibrarySwitch)rt $(LibrarySwitch)pthread $(LibrarySwitch)freetype $(LibrarySwitch)AntTweakBar $(LibrarySwitch)X11 $(LibrarySwitch)GLEW $(LibrarySwitch)BulletDynamics $(LibrarySwitch)BulletCollision $(LibrarySwitch)LinearMath $(LibrarySwitch)assimp $(LibrarySwitch)freeimage 
ArLibs                 :=  "glfw" "GL" "GLU" "glload" "rt" "pthread" "freetype" "AntTweakBar" "X11" "GLEW" "BulletDynamics" "BulletCollision" "LinearMath" "assimp" "freeimage" 
...
CXX      := g++
CC       := gcc
CXXFLAGS :=  -pg -g -O0 -fpermissive $(Preprocessors)
...
Objects1=$(IntermediateDirectory)/src_script_as_string_util.cpp$(ObjectSuffix) \
	...
	$(IntermediateDirectory)/src_libGL_s_window.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_libGL_freetype-gl_edtaa3func.c$(ObjectSuffix) 
...
Objects4=$(IntermediateDirectory)/src_script_as_scriptarray.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_script_as_callfunc_ppc_64.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_script_as_callfunc_sh4.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_script_as_scriptbuilder.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_physfs_physfs_platform_winrt.cpp$(ObjectSuffix) \
	...
	$(IntermediateDirectory)/src_script_as_scriptfunction.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_libGL_s_physicsCollision.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_script_as_bytecode.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_script_as_builder.cpp$(ObjectSuffix) 

Objects5=$(IntermediateDirectory)/src_script_as_callfunc_x64_gcc.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_script_as_scriptnode.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_script_as_gc.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_system_s_leakDetector.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_system_s_main.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_system_s_globals.cpp$(ObjectSuffix) \
	$(IntermediateDirectory)/src_system_s_render.cpp$(ObjectSuffix) $(IntermediateDirectory)/src_physfs_physfs_archiver_dir.c$(ObjectSuffix) 
...
## Objects
##
$(IntermediateDirectory)/src_libGL_freetype-gl_distance-field.c$(ObjectSuffix): src/libGL/freetype-gl/distance-field.c $(IntermediateDirectory)/src_libGL_freetype-gl_distance-field.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/freetype-gl/distance-field.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_freetype-gl_distance-field.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_freetype-gl_distance-field.c$(DependSuffix): src/libGL/freetype-gl/distance-field.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_distance-field.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_distance-field.c$(DependSuffix) -MM src/libGL/freetype-gl/distance-field.c

$(IntermediateDirectory)/src_libGL_freetype-gl_distance-field.c$(PreprocessSuffix): src/libGL/freetype-gl/distance-field.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_distance-field.c$(PreprocessSuffix) src/libGL/freetype-gl/distance-field.c

$(IntermediateDirectory)/src_libGL_freetype-gl_font-manager.c$(ObjectSuffix): src/libGL/freetype-gl/font-manager.c $(IntermediateDirectory)/src_libGL_freetype-gl_font-manager.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/freetype-gl/font-manager.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_freetype-gl_font-manager.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_freetype-gl_font-manager.c$(DependSuffix): src/libGL/freetype-gl/font-manager.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_font-manager.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_font-manager.c$(DependSuffix) -MM src/libGL/freetype-gl/font-manager.c

$(IntermediateDirectory)/src_libGL_freetype-gl_font-manager.c$(PreprocessSuffix): src/libGL/freetype-gl/font-manager.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_font-manager.c$(PreprocessSuffix) src/libGL/freetype-gl/font-manager.c

$(IntermediateDirectory)/src_libGL_freetype-gl_text-buffer.c$(ObjectSuffix): src/libGL/freetype-gl/text-buffer.c $(IntermediateDirectory)/src_libGL_freetype-gl_text-buffer.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/freetype-gl/text-buffer.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_freetype-gl_text-buffer.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_freetype-gl_text-buffer.c$(DependSuffix): src/libGL/freetype-gl/text-buffer.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_text-buffer.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_text-buffer.c$(DependSuffix) -MM src/libGL/freetype-gl/text-buffer.c

$(IntermediateDirectory)/src_libGL_freetype-gl_text-buffer.c$(PreprocessSuffix): src/libGL/freetype-gl/text-buffer.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_text-buffer.c$(PreprocessSuffix) src/libGL/freetype-gl/text-buffer.c

$(IntermediateDirectory)/src_libGL_freetype-gl_texture-atlas.c$(ObjectSuffix): src/libGL/freetype-gl/texture-atlas.c $(IntermediateDirectory)/src_libGL_freetype-gl_texture-atlas.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/freetype-gl/texture-atlas.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_freetype-gl_texture-atlas.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_freetype-gl_texture-atlas.c$(DependSuffix): src/libGL/freetype-gl/texture-atlas.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_texture-atlas.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_texture-atlas.c$(DependSuffix) -MM src/libGL/freetype-gl/texture-atlas.c

$(IntermediateDirectory)/src_libGL_freetype-gl_texture-atlas.c$(PreprocessSuffix): src/libGL/freetype-gl/texture-atlas.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_texture-atlas.c$(PreprocessSuffix) src/libGL/freetype-gl/texture-atlas.c

$(IntermediateDirectory)/src_libGL_freetype-gl_texture-font.c$(ObjectSuffix): src/libGL/freetype-gl/texture-font.c $(IntermediateDirectory)/src_libGL_freetype-gl_texture-font.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/freetype-gl/texture-font.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_freetype-gl_texture-font.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_freetype-gl_texture-font.c$(DependSuffix): src/libGL/freetype-gl/texture-font.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_texture-font.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_texture-font.c$(DependSuffix) -MM src/libGL/freetype-gl/texture-font.c

$(IntermediateDirectory)/src_libGL_freetype-gl_texture-font.c$(PreprocessSuffix): src/libGL/freetype-gl/texture-font.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_texture-font.c$(PreprocessSuffix) src/libGL/freetype-gl/texture-font.c

$(IntermediateDirectory)/src_libGL_freetype-gl_platform.c$(ObjectSuffix): src/libGL/freetype-gl/platform.c $(IntermediateDirectory)/src_libGL_freetype-gl_platform.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/freetype-gl/platform.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_freetype-gl_platform.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_freetype-gl_platform.c$(DependSuffix): src/libGL/freetype-gl/platform.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_platform.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_platform.c$(DependSuffix) -MM src/libGL/freetype-gl/platform.c

$(IntermediateDirectory)/src_libGL_freetype-gl_platform.c$(PreprocessSuffix): src/libGL/freetype-gl/platform.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_platform.c$(PreprocessSuffix) src/libGL/freetype-gl/platform.c

$(IntermediateDirectory)/src_libGL_freetype-gl_utf8-utils.c$(ObjectSuffix): src/libGL/freetype-gl/utf8-utils.c $(IntermediateDirectory)/src_libGL_freetype-gl_utf8-utils.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/freetype-gl/utf8-utils.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_freetype-gl_utf8-utils.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_freetype-gl_utf8-utils.c$(DependSuffix): src/libGL/freetype-gl/utf8-utils.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_utf8-utils.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_utf8-utils.c$(DependSuffix) -MM src/libGL/freetype-gl/utf8-utils.c

$(IntermediateDirectory)/src_libGL_freetype-gl_utf8-utils.c$(PreprocessSuffix): src/libGL/freetype-gl/utf8-utils.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_utf8-utils.c$(PreprocessSuffix) src/libGL/freetype-gl/utf8-utils.c
...
$(IntermediateDirectory)/src_libGL_freetype-gl_vector.c$(DependSuffix): src/libGL/freetype-gl/vector.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_vector.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_vector.c$(DependSuffix) -MM src/libGL/freetype-gl/vector.c

$(IntermediateDirectory)/src_libGL_freetype-gl_vector.c$(PreprocessSuffix): src/libGL/freetype-gl/vector.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_vector.c$(PreprocessSuffix) src/libGL/freetype-gl/vector.c
...
$(IntermediateDirectory)/src_libGL_freetype-gl_edtaa3func.c$(ObjectSuffix): src/libGL/freetype-gl/edtaa3func.c $(IntermediateDirectory)/src_libGL_freetype-gl_edtaa3func.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/freetype-gl/edtaa3func.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_freetype-gl_edtaa3func.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_freetype-gl_edtaa3func.c$(DependSuffix): src/libGL/freetype-gl/edtaa3func.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_edtaa3func.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_edtaa3func.c$(DependSuffix) -MM src/libGL/freetype-gl/edtaa3func.c

$(IntermediateDirectory)/src_libGL_freetype-gl_edtaa3func.c$(PreprocessSuffix): src/libGL/freetype-gl/edtaa3func.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_edtaa3func.c$(PreprocessSuffix) src/libGL/freetype-gl/edtaa3func.c
...
$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-attribute.c$(ObjectSuffix): src/libGL/freetype-gl/vertex-attribute.c $(IntermediateDirectory)/src_libGL_freetype-gl_vertex-attribute.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/freetype-gl/vertex-attribute.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-attribute.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-attribute.c$(DependSuffix): src/libGL/freetype-gl/vertex-attribute.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-attribute.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-attribute.c$(DependSuffix) -MM src/libGL/freetype-gl/vertex-attribute.c

$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-attribute.c$(PreprocessSuffix): src/libGL/freetype-gl/vertex-attribute.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_vertex-attribute.c$(PreprocessSuffix) src/libGL/freetype-gl/vertex-attribute.c
...
$(IntermediateDirectory)/src_system_s_camera3.cpp$(ObjectSuffix): src/system/s_camera3.cpp $(IntermediateDirectory)/src_system_s_camera3.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/system/s_camera3.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_system_s_camera3.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_bsp_s_convertBSP.cpp$(ObjectSuffix): src/bsp/s_convertBSP.cpp $(IntermediateDirectory)/src_bsp_s_convertBSP.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/bsp/s_convertBSP.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_bsp_s_convertBSP.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-buffer.c$(ObjectSuffix): src/libGL/freetype-gl/vertex-buffer.c $(IntermediateDirectory)/src_libGL_freetype-gl_vertex-buffer.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/freetype-gl/vertex-buffer.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-buffer.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-buffer.c$(DependSuffix): src/libGL/freetype-gl/vertex-buffer.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-buffer.c$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-buffer.c$(DependSuffix) -MM src/libGL/freetype-gl/vertex-buffer.c

$(IntermediateDirectory)/src_libGL_freetype-gl_vertex-buffer.c$(PreprocessSuffix): src/libGL/freetype-gl/vertex-buffer.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_freetype-gl_vertex-buffer.c$(PreprocessSuffix) src/libGL/freetype-gl/vertex-buffer.c
...
$(IntermediateDirectory)/src_game_s_objects.cpp$(ObjectSuffix): src/game/s_objects.cpp $(IntermediateDirectory)/src_game_s_objects.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/game/s_objects.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_game_s_objects.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_libGL_s_physicsCollision.cpp$(ObjectSuffix): src/libGL/s_physicsCollision.cpp $(IntermediateDirectory)/src_libGL_s_physicsCollision.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/libGL/s_physicsCollision.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_libGL_s_physicsCollision.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_libGL_s_physicsCollision.cpp$(DependSuffix): src/libGL/s_physicsCollision.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_libGL_s_physicsCollision.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_libGL_s_physicsCollision.cpp$(DependSuffix) -MM src/libGL/s_physicsCollision.cpp

$(IntermediateDirectory)/src_libGL_s_physicsCollision.cpp$(PreprocessSuffix): src/libGL/s_physicsCollision.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_libGL_s_physicsCollision.cpp$(PreprocessSuffix) src/libGL/s_physicsCollision.cpp
...
$(IntermediateDirectory)/src_system_s_leakDetector.cpp$(ObjectSuffix): src/system/s_leakDetector.cpp $(IntermediateDirectory)/src_system_s_leakDetector.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/dberry/Documents/Devel/1_Current/GL3/Current/Droid_3D/src/system/s_leakDetector.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_system_s_leakDetector.cpp$(ObjectSuffix) $(IncludePath)
